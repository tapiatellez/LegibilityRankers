...
def obtainGrade(lRF, lLF, testRF, testLF, tMatrix, CV):
    ...
    for (vecRF, vecLF) in zip(lRF, lLF):
        ...
        grade = grade + 1
#   The following function receives a training matrix a classyfying vec related
#   to that matrix and the concatenated vector
...
(testVecRF, testVecLF) = obtainTest(dimRelFreqMatrixLic, dimLogFreqMatrixLic)
#print(testVecRF)
#print(testVecLF)
...
# for i in range(10):
#     (testVecRF, testVecLF) = obtainTest(dimRelFreqMatrixDoctorado, dimLogFreqMatrixDoctorado)
#     (randVecRFList, randVecLFList) = obtainRandomVectors(dimRelFreqMatrixTSU, dimLogFreqMatrixTSU,dimRelFreqMatrixLic, dimLogFreqMatrixLic, dimRelFreqMatrixMaestria, dimLogFreqMatrixMaestria, dimRelFreqMatrixDoctorado, dimLogFreqMatrixDoctorado)
#     print("Test", i, ":")
#     obtainGrade(randVecRFList, randVecLFList, testVecLF, testVecRF, tMatrixG, classVecG)
# print(len(conTSULic))
# print(len(conLicMaestria))
# print(len(conMaestriaDoctorado))
