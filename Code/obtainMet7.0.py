...
random_list = obtainRandomVectorsR(twentyConTSU, twentyConLic, twentyConMaestria, twentyConDoctorado)
...
centroid_list = obtainCentroids(twentyConTSU, twentyConLic, twentyConMaestria, twentyConDoctorado)
