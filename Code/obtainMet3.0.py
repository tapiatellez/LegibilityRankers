...
conTSU = concatenateDictionaries(dimRelFreqMatrixTSU, dimLogFreqMatrixTSU)
conLic = concatenateDictionaries(dimRelFreqMatrixLic, dimLogFreqMatrixLic)
conMaestria = concatenateDictionaries(dimRelFreqMatrixMaestria, dimLogFreqMatrixMaestria)
conDoctorado = concatenateDictionaries(dimRelFreqMatrixDoctorado, dimLogFreqMatrixDoctorado)
# print(conTSU[0])
# print(len(conTSU))
# print(len(conTSU[0]))

#  We get the +1 and -1 classification
POneTSU, MOneTSU = comData(conTSU, conLic)
POneLic, MOneLic = comData(conLic, conMaestria)
POneMaestria, MOneMaestria = comData(conMaestria, conDoctorado)
print(POneTSU[0])
print("TSU-Lic:", len(POneTSU))
print("Lic-TSU:", len(MOneTSU))
print("Lic-Maestria:", len(POneLic))
print("Maestria-Lic:", len(MOneLic))
print("Maestria-Doctorado:", len(POneMaestria))
print("Doctorado-Maestria:", len(MOneMaestria))

#   We put all the data together
M, y = allTogetherNow(POneTSU, MOneTSU, POneLic, MOneLic, POneMaestria, MOneMaestria)
print(M)
print(y)
print("Length M:", len(M))
print("Length y:", len(y))

# #   Let's divide the data in 80% and 20%
# trainingM, testM = getEightyTwenty(M, y)
# print(trainingMatrix)
# print("Length Training Matrix: ", trainingM)
# print(testM)
# print("Length Test Matrix: ", testM)
