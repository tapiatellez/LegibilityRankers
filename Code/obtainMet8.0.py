...
TSU_matrix, Lic_matrix, Maestria_matrix, Doctorado_matrix  = getNVectors(24,TSU_matrix, Lic_matrix, Maestria_matrix, Doctorado_matrix )
...
evaluator_matrix, y = testEvaluatorMatrix(twentyConTSU, twentyConLic, twentyConMaestria, twentyConDoctorado)
